    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.CharField(choices=[('FINANCE', 'FIN'), ('POLITICS', 'POL'), ('POWER', 'POW'), ('COMEDY', 'COM')], default='FIN', max_length=15)),
                ('language', models.CharField(choices=[('ENGLISH', 'ENG'), ('YORUBA', 'Y0R'), ('IGBO', 'IGB'), ('HAUSA', 'HAU'), ('PIDGIN', 'PID')], default='ENG', max_length=15)),
